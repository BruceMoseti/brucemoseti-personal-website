...
const ITEMS = [
  { id: "i", badge: "I", title: "EDUCATION", subtitle: "NJIT / Coursework", rank: 4 },
  { id: "ii", badge: "II", title: "SKILLS", subtitle: "Languages / Systems", rank: 5 },
  { id: "iii", badge: "III", title: "PROJECTS", subtitle: "Research / Full Stack", rank: 5 },
  { id: "iv", badge: "IV", title: "EXPERIENCE", subtitle: "Internships / Research", rank: 5 },
];
...
const DETAILS = [
  {
    ...
    progress: "2028",
    bullets: [
      "B.S. Electrical Engineering · Expected May 2028",
      "Relevant Coursework: Data Structures & Algorithms, Computer Architecture, Operating Systems, Signals & Systems",
      "Research and systems experience aligned with engineering and AI performance work.",
    ],
  },
  {
    index: "02",
    ...
    bullets: [
      ...
      "Node.js · React · REST APIs · Git · Linux",
      "Object-Oriented Design · Client-Server Architecture · Debugging · Performance Optimization",
    ],
  },
  {
    index: "03",
    ...
    progress: "03",
    bullets: [
      "AI Imaging Analysis and GPU-Accelerated Systems — NVIDIA DeepSun Project",
      "Full-Stack Productivity Platform — Node.js and React",
      "AI-Powered Knowledge Assistant — LLM APIs and backend services",
    ],
  },
  {
    index: "04",
    ...
    progress: "05",
    bullets: [
      "NVIDIA — Incoming Performance Engineering Intern, Edge AI | Summer 2026",
      "NOKIA — Optoelectronics Test Development Co-op | Sep 2025 - Dec 2025",
      "PSEG — Technical Solutions Intern | Jan 2025 - Jun 2025",
      "NJIT CIBM3 Labs — Researcher | Summer 2025",
      "EN-POWER GROUP — Electrical Design Engineer Intern | Dec 2024 - Jan 2025",
    ],
  },
];
    ...
    <div id="menu-screen">
      ...
      <div className="resume-overlay">
        ...
        {DETAILS.map((detail, detailIndex) => (
          active === detailIndex ? (
            <div className="resume-detail-panel" key={detailIndex}>
              ...
              <div className="resume-detail-list">
                {detail.bullets.map((bullet, index) => (
                  <div className="resume-detail-row" key={bullet}>
                    <div className="resume-detail-row-index">{String(index + 1).padStart(2, "0")}</div>
                    <div className="resume-detail-row-title">{bullet}</div>
                  </div>
                ))}
              </div>
