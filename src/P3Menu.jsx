...
const ITEMS = [
  ...
  { id: "projects", label: "PROJECTS", page: "projects", fontSize: 72, offsetX: 14, offsetY: 6,  skew: -7,  skewY: 8   },
  { id: "contact",  label: "CONTACT",  page: "socials",  fontSize: 74, offsetX: 16, offsetY: 8,  skew: -3,  skewY: 5   },
];
